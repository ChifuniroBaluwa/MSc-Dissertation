...
##COMBINING DATASETS FOR visualisation and analysis
...
#write_sf(cholera_cases, "intermediaries/cholera_cases_dissert.geojson")
write_sf(cholera_cases, "intermediaries/cholera_cases_dissert.shp")
#####################################################################################
...
write_sf(dataset_cholera_cases, "intermediaries/cholera_case_summaries_dissert.shp")
